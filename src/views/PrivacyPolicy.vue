<template>
  <body>
    <div class="container mx-auto px-4 h-full">
      <p class="rounded-t mb-0 py-6 font-bold text-emerald-600 text-3xl">
        Privacy Policy for AlphaWave
      </p>
    </div>

    <div>
      <div class="text-sm container mx-auto px-4 h-full">
        <div
          class="
            tab-content
          ...
          id="en"
        >
          <h1 class="font-semibold text-lg">Privacy Policy</h1>
          ...
          <h1 class="pt-8 text-xl font-semibold">
            Interpretation and Definitions
          </h1>
          <h2 class="pt-8 text-lg font-semibold">Interpretation</h2>
          <p>
          ...
          <h2 class="pt-8 text-lg font-semibold">Definitions</h2>
          ...
          <ul class="list-disc list-outside">
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to AlphaWave.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to AlphaWave, accessible from
                <a
                  href="https://www.alpha-wave.xyz"
                  rel="external nofollow noopener"
                  target="_blank"
                  >https://www.alpha-wave.xyz</a
                >
              </p>
            </li>
            <li>
          ...
          <h2 class="pt-8 text-lg font-semibold">Types of Data Collected</h2>
          <h3 class="pt-8 text-m font-semibold">Personal Data</h3>
          <p>
          ...
          <h3 class="pt-8 text-m font-semibold">Usage Data</h3>
          ...
          <h3 class="pt-8 text-m font-semibold">
          ...
          <h2 class="pt-8 text-lg font-semibold">Use of Your Personal Data</h2>
          ...
          <h2 class="pt-8 text-lg font-semibold">
          ...
          <h3 class="pt-8 text-m font-semibold">Business Transactions</h3>
          <p>
          ...
          <h3 class="pt-8 text-m font-semibold">Law enforcement</h3>
          <p>
          ...
          <h3 class="pt-8 text-m font-semibold">Other legal requirements</h3>
          <p>
          ...
          <h1 class="text-xl font-semibold">Children's Privacy</h1>
          <p>
          ...
          <h1 class="text-xl font-semibold">Links to Other Websites</h1>
          <p>
          ...
          <h1 class="text-xl font-semibold">Changes to this Privacy Policy</h1>
          <p>
          ...
          <div class="text-justify">
            <ul class="list-outside">
              <li>
                By email:
                <strong> l02aezups@mozmail.com </strong>
              </li>
            </ul>
          </div>
        </div>
      ...
      <button @click="fakelogin">
    FAKELOGIN {{$store.state.loginState}}
  </button>
   <button @click="fakelogout">
    FAKELOGOUT {{$store.state.loginState}}
  </button>
  <button @click="fakelogout2">
    THIRD BUTTON {{$store.state.loginState}}
  </button>
  </body>
...
export default {
  setup(){
    ...
    function fakelogin(){
      store.dispatch("fakelogin", title.value);
    }
    function fakelogout(){
      store.dispatch("fakelogout", false);
    }
    function fakelogout2(){
      store.commit("thirdfunc",false);
    }
    return {fakelogin, fakelogout, fakelogout2};
  },
	data() {
		return {
			text: '',
	...
	// computed: { users: () => store.state.user },
	methods: {
		// fakelogin() {
			// store.commit('fakelogin', this.user);
			// this.text = ''
