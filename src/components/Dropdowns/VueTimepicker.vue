...
<span class="vue__time-picker" :style="inputWidthStyle">
  <input type="text" class="vue__time-picker-input rounded text-gray-300" ref="input"
  ...
  <div class="dropdown" v-show="showDropdown" tabindex="-1"
    ...
    <div class="select-list text-gray-300" :style="inputWidthStyle" tabindex="-1">
      ...
      <template v-if="!advancedKeyboard">
        <template v-for="column in columnsSequence" :key="column">
          <ul v-if="column === 'hour'" class="hours text-gray-300" @scroll="keepFocusing">
            <li class="hint text-gray-300" v-text="hourLabelText"></li>
          ...
          <ul v-if="column === 'minute'" class="minutes text-gray-300" @scroll="keepFocusing">
